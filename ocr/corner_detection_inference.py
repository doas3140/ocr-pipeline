...
__all__ = ['PaperCornerPredictor', 'points_on_mask', 'show_points_on_mask']
...
# Cell
def points_on_mask(mask, o): # o - (8,) shape arr w/ points x,y coords
    mask = mask.copy()
    for i, c in zip(range(0,8,2), [(255,0,0), (0,255,0), (0,0,255), (255,255,0)]):
        mask = cv2.circle(mask, (o[i], o[i+1]), radius=15, color=c, thickness=50)
    return mask

def show_points_on_mask(mask, o): # o - (8,) shape arr w/ points x,y coords
    return plot(points_on_mask(mask, o))